...
export const positions: Position[] = [
  ...
  },
  {
    ...
    heat: 842,
    selectedCount: 176,
    skillIds: ['sk-opt-05', 'sk-opt-06', 'sk-alg-05'],
    selected: false,
  },
  {
    id: 'pos-edge',
    ...
    heat: 968,
    selectedCount: 154,
    skillIds: ['sk-dep-01', 'sk-dep-02', 'sk-dep-03', 'sk-dep-05', 'sk-dep-06'],
    selected: false,
  },
  {
    id: 'pos-data',
    ...
    heat: 1230,
    selectedCount: 402,
    skillIds: ['sk-dl-01', 'sk-dl-02', 'sk-dl-06'],
    selected: false,
  },
  {
    id: 'pos-robot',
    ...
    heat: 903,
    selectedCount: 188,
    skillIds: ['sk-alg-07', 'sk-dep-03', 'sk-dep-04'],
    selected: false,
  },
]
...
const PROJECT_SEEDS: ProjectSeed[] = [
  ...
  },
  {
    ...
    tier: 'basic',
    positionId: 'pos-iv',
    skillIds: ['sk-opt-01', 'sk-opt-02', 'sk-alg-03', 'sk-dl-02'],
    status: 'in_progress',
    levelDone: 3,
  ...
  },
  {
    ...
    tier: 'advanced',
    positionId: 'pos-iv',
    skillIds: ['sk-alg-03', 'sk-alg-04', 'sk-dl-05'],
    status: 'not_started',
    levelDone: 0,
  ...
  },
  {
    ...
    tier: 'advanced',
    positionId: 'pos-dl',
    skillIds: ['sk-alg-04', 'sk-alg-05', 'sk-alg-06', 'sk-dl-04', 'sk-dl-05'],
    status: 'locked',
    levelDone: 0,
  ...
  },
  {
    ...
    tier: 'extended',
    positionId: 'pos-dl',
    skillIds: ['sk-opt-03', 'sk-opt-04', 'sk-dl-01', 'sk-dl-03', 'sk-dl-06', 'sk-dl-07'],
    status: 'not_started',
    levelDone: 0,
